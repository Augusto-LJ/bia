...
# Build do front-end com Vite. Aqui está a URL do load balancer
RUN cd client && VITE_API_URL=http://bia-alb-900003933.us-east-1.elb.amazonaws.com npm run build
